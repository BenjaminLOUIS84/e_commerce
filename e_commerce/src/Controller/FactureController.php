...
class FactureController extends AbstractController
{
    ...
    // Fonction pour envoyer un mail pour avertir tous les clients que l'édition numérique est disponible en téléchargement
    ...
    //         // On va chercher l'utilisateur par son email
    //         $users = $userRepository->findByEmail($form->get('email')->getData());    // Pour chercher les données dans l'email qui est inscrit dans le formulaire
    ...
    //     return $this->render('facture/news.html.twig', [ // Passer le formulaire en arguement dans un tableau
            
    //         'newsForm' => $form->createView()                        // Demande pour créer le formulaire 'requestPassFrom' et pour afficher selui-ci dans une vue
    //     ]);  
    // }
